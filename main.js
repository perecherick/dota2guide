...
$('back').onclick = function() {
  var heroDescription = document.getElementById("details");
  heroDescription.textContent = "";

  var recomendetItemsDiv = document.getElementById("details");
